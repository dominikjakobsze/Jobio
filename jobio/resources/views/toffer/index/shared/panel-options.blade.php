<form data-form-options
    class="f fr fw cs is js ss gap-2 md:gap-3 w-[100%] md:w-[50%] max-w-[550px] translate-x-[-120%] p-1 md:p-2 bg-white z-[201] fixed top-0 left-0 h-[100dvh] overflow-x-hidden overflow-y-auto shadow-lg drop-shadow-lg text-gray-700">
    <panel-toolbar class="f is cs justify-end ss fr fw p-3 flex-[0_0_100%] gap-5">
        <panel-toolbar-icon data-search-offers
        ...
        <panel-toolbar-icon data-close-panel
            class="f is cs js ss fr fw flex-[0_1_auto] p-3 bg-gray-100 shadow-sm drop-shadow-sm rounded-xl text-gray-700 hover:brightness-105 cup">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="flex-[0_0_24px] h-[24px]">
    ...
    <panel-spacer class="f flex-[0_0_100%] h-[1px] bg-gray-200"></panel-spacer>
    <panel-option-container class="p-2 flex-[0_0_100%] f cs is jc ss fr fw gap-2 md:gap-8">
        <input name="offer-min_salary"
            class="flex-[0_0_100%] md:flex-[0_0_45%] text-gray-700 text-sm font-[400] rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
    ...
    <panel-spacer class="f flex-[0_0_100%] h-[1px] bg-gray-200"></panel-spacer>
    <panel-option-container class="p-1 md:p-2 flex-[0_0_100%] f cs is jc md:js ss fr fw gap-1 md:gap-2">
        @foreach ($items['options']['option-option_type-s'] as $item)
            <label data-checkbox
                class="f fr fnw cc js ic ss flex-[0_1_auto] font-[400] text-sm gap-1 bg-gray-100 py-0 px-1 md:px-2 cup rounded-lg">
