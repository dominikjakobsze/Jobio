<panel-columns data-panel-columns
    class="f fr fw cs is js ss gap-3 w-[50%] max-w-[550px] translate-x-[-120%] p-2 bg-white z-[201] fixed top-0 left-0 h-[100dvh] overflow-x-hidden overflow-y-auto shadow-lg drop-shadow-lg text-gray-700">
